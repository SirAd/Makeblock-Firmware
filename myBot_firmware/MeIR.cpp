...
MeIr_Map meirmap[17] = {{0xB946,0x40},{0xBB44,0x07},{0xBF40,0x15},{0xBC43,0x09},{0xEA15,0x19},
 {0xE916,0x0c},{0xE619,0x18},{0xF20D,0x5e},{0xF30C,0x08},{0xE718,0x1c},
 {0xA15E,0x5a},{0xF708,0x42},{0xE31C,0x52},{0xA55A,0x4a},{0xAD52,0x16},
 {0xBD42,0x45},{0xB54A,0x46}};
...
ISR(TIMER_INTR_NAME)
{
  uint8_t irdata = (uint8_t)digitalRead(7);
...
char MeIR::charPressed(unsigned long int v) {
  int i=0;

  for (i=0;i<17;i++) {
    if (meirmap[i].value == v) return meirmap[i].c;
  }
